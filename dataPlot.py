...
def logPlotAxTest():
    ...
    dataFile1=unicode('C:\Users\Levit\Experiment Data\德令哈测试\\20171226\零基线实验\\20171227015305-tdc2_5_filterN_coindence_filtered_250-350s_residual-2-0.1s-ps_TDEV.txt','utf8')
    ...
    dataFile2 =unicode('C:\Users\Levit\Experiment Data\双站数据\\20180108\\result\\synCoincidence-165-265--11-0-Coin-紫台WGS84-atm-factor-neworbit_filtered_residual-2-0.1s-ps_TDEV.txt','utf8')

    dataFile3  =unicode('C:\Users\Levit\Experiment Data\双站数据\\20180108\\result\\synCoincidence-165-265--11-0-Coin-紫台WGS84-atm-factor-neworbit_filtered_residual-5-0.1s-ps_TDEV.txt','utf8')
    ...
    fig=plt.figure()
    logPlotAx(List1,fig,'g','--','o','12.26 DLH-DLH,250-350s,2 order fit')
    logPlotAx(List2,fig,'r','--','s','01.08 LJ-DLH,165-265s, 2 order fit')
    logPlotAx(List3,fig,'c','--','^','01.08 LJ-DLH,165-265s, 5 order fit')
