...
def logPlotAxTest():
    dataFile1=unicode('E:\Experiment Data\时频传输数据处理\双站数据处理\\3.2\\Result\\3.2-85-250-0.01sec-correct-filter.txt','utf8')
    ...
    dataFile2=unicode('E:\Experiment Data\时频传输数据处理\本地光路系统测试\\6.13\\6.13-2k-0.01s-all.txt','utf8')
    ...
    fig=plt.figure()
    logPlotAx(List1,fig,'g','--','o','3.2DLH-LJ Correct')
    logPlotAx(List2,fig,'r','--','s','2 TDC compare')
